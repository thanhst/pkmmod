...
public final class b_s implements b0.b {

    /* renamed from: a, reason: collision with root package name and from kotlin metadata */
    @NotNull
    private final e_s<?>[] initializers;

    public b_s(@NotNull e_s<?>... initializers) {
    ...
    @Override // androidx.lifecycle.b0.b
    @NotNull
    public <T extends a0> T b(@NotNull Class<T> modelClass, @NotNull a_s extras) {
        s.e(modelClass, "modelClass");
        s.e(extras, "extras");
        T t2 = null;
        for (e_s<?> eSVar : this.initializers) {
            if (s.a(eSVar.a(), modelClass)) {
                T tInvoke = eSVar.b().invoke(extras);
