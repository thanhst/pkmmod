...
public final class c_s {
    ...
    @NotNull
    private final List<e_s<?>> initializers = new ArrayList();

    public final <T extends a0> void a(@NotNull kotlin.reflect.c<T> clazz, @NotNull l_p0<? super a_s, ? extends T> initializer) {
        s.e(clazz, "clazz");
        s.e(initializer, "initializer");
        this.initializers.add(new e_s<>(a_o0.a(clazz), initializer));
    }

    @NotNull
    public final b0.b b() {
        Object[] array = this.initializers.toArray(new e_s[0]);
        if (array == null) {
            throw new NullPointerException("null cannot be cast to non-null type kotlin.Array<T of kotlin.collections.ArraysKt__ArraysJVMKt.toTypedArray>");
        }
        e_s[] eSVarArr = (e_s[]) array;
        return new b_s((e_s[]) Arrays.copyOf(eSVarArr, eSVarArr.length));
    }
}
