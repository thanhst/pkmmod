...
public final class e_p {
    ...
    public e_p(@NonNull Uri uri, @NonNull ClipDescription clipDescription, @Nullable Uri uri2) {
    ...
    @Nullable
    public static e_p f(@Nullable Object obj) {
        if (obj != null && Build.VERSION.SDK_INT >= 25) {
            return new e_p(new a(obj));
        }
        return null;
    }
