...
public final class d_p {
    ...
    class a extends InputConnectionWrapper {
        ...
        public boolean commitContent(InputContentInfo inputContentInfo, int i2, Bundle bundle) {
            if (this.f4049a.a(e_p.f(inputContentInfo), i2, bundle)) {
                return true;
            }
    ...
    class b extends InputConnectionWrapper {
        ...
        public boolean performPrivateCommand(String str, Bundle bundle) {
            if (d_p.e(str, bundle, this.f4050a)) {
                return true;
            }
    ...
    /* compiled from: InputConnectionCompat.java */
    public interface c {
        boolean a(@NonNull e_p ePVar, int i2, @Nullable Bundle bundle);
    }
    ...
    private static c b(@NonNull final View view) {
        ...
        return new c() { // from class: p.c
            @Override // p.d.c
            public final boolean a(e_p ePVar, int i2, Bundle bundle) {
                return d_p.f(view, ePVar, i2, bundle);
            }
        };
    }
    ...
    public static InputConnection d(@NonNull InputConnection inputConnection, @NonNull EditorInfo editorInfo, @NonNull c cVar) {
        ...
        return Build.VERSION.SDK_INT >= 25 ? new a(inputConnection, false, cVar) : b_p.a(editorInfo).length == 0 ? inputConnection : new b(inputConnection, false, cVar);
    }
    ...
    static boolean e(@Nullable String str, @Nullable Bundle bundle, @NonNull c cVar) throws Throwable {
        ...
        try {
            ...
            if (uri != null && clipDescription != null) {
                A = cVar.a(new e_p(uri, clipDescription, uri2), i2, bundle2);
            }
            if (resultReceiver != 0) {
    ...
    public static /* synthetic */ boolean f(View view, e_p ePVar, int i2, Bundle bundle) {
        if (Build.VERSION.SDK_INT >= 25 && (i2 & 1) != 0) {
            try {
                ePVar.d();
                InputContentInfo inputContentInfo = (InputContentInfo) ePVar.e();
        ...
        return ViewCompat.H(view, new ContentInfoCompat.a(new ClipData(ePVar.b(), new ClipData.Item(ePVar.a())), 2).d(ePVar.c()).b(bundle).a()) == null;
    }
}
