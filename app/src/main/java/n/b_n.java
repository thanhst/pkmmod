...
public interface b_n extends MenuItem {
    @NonNull
    b_n a(@Nullable androidx.core.view.b bVar);
    ...
    @Override // android.view.MenuItem
    @NonNull
    b_n setContentDescription(@Nullable CharSequence charSequence);
    ...
    @Override // android.view.MenuItem
    @NonNull
    b_n setTooltipText(@Nullable CharSequence charSequence);
}
