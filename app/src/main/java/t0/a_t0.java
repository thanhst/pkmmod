...
public final class a_t0 implements Comparable<a_t0> {
    ...
    private static final long f4128h = c_t0.e(4611686018427387903L);

    /* renamed from: i, reason: collision with root package name */
    private static final long f4129i = c_t0.e(-4611686018427387903L);
    ...
    public static long e(long j2) {
        if (b_t0.a()) {
            if (v(j2)) {
                if (!new i_s0(-4611686018426999999L, 4611686018426999999L).d(r(j2))) {
                    throw new AssertionError(r(j2) + " ns is out of nanoseconds range");
                }
            } else {
                if (!new i_s0(-4611686018427387903L, 4611686018427387903L).d(r(j2))) {
                    throw new AssertionError(r(j2) + " ms is out of milliseconds range");
                }
                if (new i_s0(-4611686018426L, 4611686018426L).d(r(j2))) {
    ...
    public static boolean f(long j2, Object obj) {
        return (obj instanceof a_t0) && j2 == ((a_t0) obj).getRawValue();
    }
    ...
    public static final int o(long j2) {
        ...
        return (int) (u(j2) ? c_t0.f(r(j2) % 1000) : r(j2) % 1000000000);
    }
    ...
    public /* bridge */ /* synthetic */ int compareTo(a_t0 aS0Var) {
        return c(aS0Var.getRawValue());
    }
