...
public final class JsonAdapterAnnotationTypeAdapterFactory implements TypeAdapterFactory {
    ...
    TypeAdapter<?> getTypeAdapter(ConstructorConstructor constructorConstructor, Gson gson, TypeToken<?> typeToken, JsonAdapter jsonAdapter) {
        ...
        if (objConstruct instanceof TypeAdapter) {
            ...
            boolean z2 = objConstruct instanceof JsonSerializer;
            if (!z2 && !(objConstruct instanceof JsonDeserializer)) {
            ...
            treeTypeAdapter = new TreeTypeAdapter<>(z2 ? (JsonSerializer) objConstruct : null, objConstruct instanceof JsonDeserializer ? (JsonDeserializer) objConstruct : null, gson, typeToken, null);
        }
