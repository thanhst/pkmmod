...
public class GetServiceRequest extends AbstractSafeParcelable {
    ...
    public void writeToParcel(Parcel parcel, int i2) {
        ...
        SafeParcelWriter.writeTypedArray(parcel, 6, this.zzdj, i2, false);
        SafeParcelWriter.writeBundle(parcel, 7, this.zzdk, false);
        SafeParcelWriter.writeParcelable(parcel, 8, this.zzdl, i2, false);
        SafeParcelWriter.writeTypedArray(parcel, 10, this.zzdm, i2, false);
        SafeParcelWriter.writeTypedArray(parcel, 11, this.zzdn, i2, false);
        SafeParcelWriter.writeBoolean(parcel, 12, this.zzdo);
        SafeParcelWriter.finishObjectHeader(parcel, iBeginObjectHeader);
    }

    @SafeParcelable.Constructor
    GetServiceRequest(@SafeParcelable.Param(id = 1) int i2, @SafeParcelable.Param(id = 2) int i3, @SafeParcelable.Param(id = 3) int i4, @SafeParcelable.Param(id = 4) String str, @SafeParcelable.Param(id = 5) IBinder iBinder, @SafeParcelable.Param(id = 6) Scope[] scopeArr, @SafeParcelable.Param(id = 7) Bundle bundle, @SafeParcelable.Param(id = 8) Account account, @SafeParcelable.Param(id = 10) Feature[] featureArr, @SafeParcelable.Param(id = 11) Feature[] featureArr2, @SafeParcelable.Param(id = 12) boolean z2) {
        this.version = i2;
        this.zzdg = i3;
        this.zzdh = i4;
