...
public final class FragmentWrapper extends IFragmentWrapper.Stub {
    ...
    public final void setHasOptionsMenu(boolean z2) {
        this.zzia.setHasOptionsMenu(z2);
    }

    @Override // com.google.android.gms.dynamic.IFragmentWrapper
    public final void setMenuVisibility(boolean z2) {
        this.zzia.setMenuVisibility(z2);
    }

    @Override // com.google.android.gms.dynamic.IFragmentWrapper
    public final void setRetainInstance(boolean z2) {
        this.zzia.setRetainInstance(z2);
    }

    @Override // com.google.android.gms.dynamic.IFragmentWrapper
    public final void setUserVisibleHint(boolean z2) {
        this.zzia.setUserVisibleHint(z2);
    }
    ...
    public final void startActivityForResult(Intent intent, int i2) {
        this.zzia.startActivityForResult(intent, i2);
    }
