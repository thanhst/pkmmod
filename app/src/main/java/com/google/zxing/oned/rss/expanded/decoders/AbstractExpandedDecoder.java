...
public abstract class AbstractExpandedDecoder {
    ...
    public static AbstractExpandedDecoder createDecoder(BitArray bitArray) {
        ...
        switch (GeneralAppIdDecoder.extractNumericValueFromBitArray(bitArray, 1, 7)) {
            case 56:
                return new AI013x0x1xDecoder(bitArray, "310", ConstantUtil.SHOW_METHOD_CONFIRM_AND_PIN);
            case 57:
                return new AI013x0x1xDecoder(bitArray, "320", ConstantUtil.SHOW_METHOD_CONFIRM_AND_PIN);
            case 58:
                return new AI013x0x1xDecoder(bitArray, "310", ConstantUtil.SHOW_METHOD_CONFIRM_SYS_BROWSER);
            case 59:
                return new AI013x0x1xDecoder(bitArray, "320", ConstantUtil.SHOW_METHOD_CONFIRM_SYS_BROWSER);
            case 60:
