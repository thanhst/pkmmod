...
public final class Model {
    ...
    @NotNull
    private static final Map<String, String> mapping = l0.g(j.a("embedding.weight", "embed.weight"), j.a("dense1.weight", "fc1.weight"), j.a("dense2.weight", "fc2.weight"), j.a("dense3.weight", "fc3.weight"), j.a("dense1.bias", "fc1.bias"), j.a("dense2.bias", "fc2.bias"), j.a("dense3.bias", "fc3.bias"));
    ...
    private Model(Map<String, MTensor> map) {
        ...
        for (String str : r0.h(ModelManager.Task.MTML_INTEGRITY_DETECT.toKey(), ModelManager.Task.MTML_APP_EVENT_PREDICTION.toKey())) {
            String strM = s.m(str, ".weight");
            String strM2 = s.m(str, ".bias");
            MTensor mTensor12 = map.get(strM);
            MTensor mTensor13 = map.get(strM2);
            if (mTensor12 != null) {
                this.finalWeights.put(strM, Operator.transpose2D(mTensor12));
            }
            if (mTensor13 != null) {
                this.finalWeights.put(strM2, mTensor13);
            }
        }
    }
    ...
    public final MTensor predictOnMTML(@NotNull MTensor dense, @NotNull String[] texts, @NotNull String task) {
        ...
        try {
            ...
            MTensor mTensor = this.finalWeights.get(s.m(task, ".weight"));
            MTensor mTensor2 = this.finalWeights.get(s.m(task, ".bias"));
