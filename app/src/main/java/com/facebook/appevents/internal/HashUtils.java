...
public final class HashUtils {
    ...
    @JvmStatic
    @Nullable
    public static final String computeChecksumWithPackageManager(@NotNull Context context, @Nullable Long nanosTimeout) throws CertificateException {
        s.e(context, "context");
        ...
        List listX = CollectionsKt___CollectionsKt.X(arrayList);
        ...
        try {
            ...
            s.d(field, "checksumClass.getField(\"TYPE_WHOLE_MD5\")");
            ...
            Object objNewProxyInstance = Proxy.newProxyInstance(HashUtils.class.getClassLoader(), new Class[]{cls}, new InvocationHandler() { // from class: com.facebook.appevents.internal.HashUtils$computeChecksumWithPackageManager$listener$1
                ...
                @Nullable
                public Object invoke(@Nullable Object o2, @NotNull Method method, @NotNull Object[] objects) {
                    s.e(method, "method");
                    s.e(objects, "objects");
                    try {
                        if (s.a(method.getName(), "onChecksumsReady") && objects.length == 1) {
                            Object obj2 = objects[0];
                            if (obj2 instanceof List) {
                                for (Object obj3 : (List) obj2) {
                                    if (obj3 != null) {
                                        Method method2 = obj3.getClass().getMethod("getSplitName", new Class[0]);
                                        s.d(method2, "c.javaClass.getMethod(\"getSplitName\")");
                                        Method method3 = obj3.getClass().getMethod("getType", new Class[0]);
                                        s.d(method3, "c.javaClass.getMethod(\"getType\")");
                                        if (method2.invoke(obj3, new Object[0]) == null && s.a(method3.invoke(obj3, new Object[0]), obj)) {
                                            Method method4 = obj3.getClass().getMethod("getValue", new Class[0]);
                                            s.d(method4, "c.javaClass.getMethod(\"getValue\")");
    ...
    private final String computeFileMd5(File file) throws Exception {
        ...
        try {
            ...
            s.d(string, "BigInteger(1, md.digest()).toString(16)");
