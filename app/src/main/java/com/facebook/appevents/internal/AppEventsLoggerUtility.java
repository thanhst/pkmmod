...
public final class AppEventsLoggerUtility {
    ...
    @NotNull
    private static final Map<GraphAPIActivityType, String> API_ACTIVITY_TYPE_TO_STRING = l0.g(j.a(GraphAPIActivityType.MOBILE_INSTALL_EVENT, "MOBILE_APP_INSTALL"), j.a(GraphAPIActivityType.CUSTOM_APP_EVENTS, "CUSTOM_APP_EVENTS"));
