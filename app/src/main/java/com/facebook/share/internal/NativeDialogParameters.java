...
public final class NativeDialogParameters {
    ...
    @JvmStatic
    @Nullable
    public static final Bundle create(@NotNull UUID callId, @NotNull ShareContent<?, ?> shareContent, boolean shouldFailOnDataError) throws FacebookException {
        s.e(callId, "callId");
    ...
    private final Bundle create(ShareCameraEffectContent cameraEffectContent, Bundle attachmentUrlsBundle, boolean dataErrorsFatal) {
        ...
        try {
            ...
            throw new FacebookException(s.m("Unable to create a JSON Object from the provided CameraEffectArguments: ", e2.getMessage()));
        }
    }
