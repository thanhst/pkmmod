...
public class VideoUploader {
    ...
    private static class StartUploadWorkItem extends UploadWorkItemBase {
        ...
        protected void handleSuccess(JSONObject jSONObject) throws JSONException, NumberFormatException {
            ...
            if (this.uploadContext.progressCallback != null) {
                ...
                uploadContext.progressCallback.onProgress(j2, uploadContext.videoSize);
            }
    ...
    public static byte[] getChunk(UploadContext uploadContext, String str, String str2) throws IOException {
        ...
        byte[] bArr = new byte[Math.min(Utility.DEFAULT_STREAM_BUFFER_SIZE, i3)];
        do {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static void issueResponse(UploadContext uploadContext, FacebookException facebookException, GraphResponse graphResponse, String str) throws JSONException, IOException {
