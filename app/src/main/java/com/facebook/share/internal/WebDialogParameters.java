...
public final class WebDialogParameters {
    ...
    public static final Bundle create(@NotNull AppGroupCreationContent appGroupCreationContent) {
        String string;
        s.e(appGroupCreationContent, "appGroupCreationContent");
    ...
    public static final Bundle create(@NotNull SharePhotoContent sharePhotoContent) {
        ...
        ArrayList arrayList = new ArrayList(v.o(photos, 10));
        ...
        if (array != null) {
            bundleCreateBaseParameters.putStringArray(ShareConstants.WEB_DIALOG_PARAM_MEDIA, (String[]) array);
            return bundleCreateBaseParameters;
        }
