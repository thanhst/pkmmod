...
public final class CustomTabUtils {
    ...
    public static final String getChromePackage() {
        ...
        try {
            ...
            kotlin.jvm.internal.s.d(listQueryIntentServices, "context.packageManager.queryIntentServices(serviceIntent, 0)");
            HashSet hashSetS = kotlin.collections.n.s(CHROME_PACKAGES);
    ...
    public static final String getDefaultRedirectURI() {
        ...
        try {
            return kotlin.jvm.internal.s.m(Validate.CUSTOM_TAB_REDIRECT_URI_PREFIX, FacebookSdk.getApplicationContext().getPackageName());
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, CustomTabUtils.class);
            return null;
        }
