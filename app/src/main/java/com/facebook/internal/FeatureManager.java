...
@Metadata(bv = {}, d1 = {"\u00006\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0007\n\u0002\u0010%\n\u0002\u0010\u0011\n\u0002\b\u0007\bÇ\u0002\u0018\u00002\u00020\u0001:\u0002\u0019\u001aB\t\b\u0002¢\u0006\u0004\b\u0017\u0010\u0018J\u0018\u0010\u0007\u001a\u00020\u00062\u0006\u0010\u0003\u001a\u00020\u00022\u0006\u0010\u0005\u001a\u00020\u0004H\u0007J\u0010\u0010\t\u001a\u00020\b2\u0006\u0010\u0003\u001a\u00020\u0002H\u0007J\u0010\u0010\n\u001a\u00020\u00062\u0006\u0010\u0003\u001a\u00020\u0002H\u0007J\u0010\u0010\r\u001a\u00020\u00022\u0006\u0010\f\u001a\u00020\u000bH\u0007J\b\u0010\u000e\u001a\u00020\u0006H\u0002J\u0010\u0010\u000f\u001a\u00020\b2\u0006\u0010\u0003\u001a\u00020\u0002H\u0002J\u0010\u0010\u0010\u001a\u00020\b2\u0006\u0010\u0003\u001a\u00020\u0002H\u0002R\u0014\u0010\u0011\u001a\u00020\u000b8\u0002X\u0082T¢\u0006\u0006\n\u0004\b\u0011\u0010\u0012R&\u0010\u0015\u001a\u0014\u0012\u0004\u0012\u00020\u0002\u0012\n\u0012\b\u0012\u0004\u0012\u00020\u000b0\u00140\u00138\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0015\u0010\u0016¨\u0006\u001b"}, d2 = {"Lcom/facebook/internal/FeatureManager;", "", "Lcom/facebook/internal/FeatureManager$Feature;", "feature", "Lcom/facebook/internal/FeatureManager$Callback;", "callback", "Lkotlin/t;", "checkFeature", "", "isEnabled", "disableFeature", "", "className", "getFeature", "initializeFeatureMapping", "getGKStatus", "defaultStatus", "FEATURE_MANAGER_STORE", "Ljava/lang/String;", "", "", "featureMapping", "Ljava/util/Map;", "<init>", "()V", "Callback", "Feature", "facebook-core_release"}, k = 1, mv = {1, 5, 1})
...
public final class FeatureManager {
    ...
    /* compiled from: FeatureManager.kt */
    @Metadata(bv = {}, d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\bæ\u0080\u0001\u0018\u00002\u00020\u0001J\u0010\u0010\u0005\u001a\u00020\u00042\u0006\u0010\u0003\u001a\u00020\u0002H&¨\u0006\u0006"}, d2 = {"Lcom/facebook/internal/FeatureManager$Callback;", "", "", "enabled", "Lkotlin/t;", "onCompleted", "facebook-core_release"}, k = 1, mv = {1, 5, 1})
    ...
    public enum Feature {
        ...
        public static final class Companion {
            ...
            public final Feature fromInt(int code) {
                ...
                int i2 = 0;
                while (i2 < length) {
                    Feature feature = featureArrValuesCustom[i2];
                    i2++;
        ...
        public final Feature getParent() {
            int i2 = this.code;
            return (i2 & 255) > 0 ? INSTANCE.fromInt(i2 & (-256)) : (65280 & i2) > 0 ? INSTANCE.fromInt(i2 & (-65536)) : (16711680 & i2) > 0 ? INSTANCE.fromInt(i2 & (-16777216)) : INSTANCE.fromInt(0);
        }

        @NotNull
        public final String toKey() {
            return kotlin.jvm.internal.s.m("FBSDKFeature", this);
        }
    ...
    public static final Feature getFeature(@NotNull String className) {
        ...
        for (Map.Entry<Feature, String[]> entry : featureMapping.entrySet()) {
            ...
            while (i2 < length) {
                String str = value[i2];
                i2++;
                if (kotlin.text.s.u(className, str, false, 2, null)) {
                    return key;
                }
            }
        }
    ...
    private final boolean getGKStatus(Feature feature) {
        ...
        FetchedAppGateKeepersManager fetchedAppGateKeepersManager = FetchedAppGateKeepersManager.INSTANCE;
        return FetchedAppGateKeepersManager.getGateKeeperForKey(feature.toKey(), FacebookSdk.getApplicationId(), zDefaultStatus);
    }
    ...
    public static final boolean isEnabled(@NotNull Feature feature) {
        ...
        if (string != null && kotlin.jvm.internal.s.a(string, FacebookSdk.getSdkVersion())) {
            return false;
        }
