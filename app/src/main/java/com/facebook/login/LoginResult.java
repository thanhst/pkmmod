...
public final /* data */ class LoginResult {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return s.a(this.accessToken, loginResult.accessToken) && s.a(this.authenticationToken, loginResult.authenticationToken) && s.a(this.recentlyGrantedPermissions, loginResult.recentlyGrantedPermissions) && s.a(this.recentlyDeniedPermissions, loginResult.recentlyDeniedPermissions);
    }
    ...
    public /* synthetic */ LoginResult(AccessToken accessToken, AuthenticationToken authenticationToken, Set set, Set set2, int i2, kotlin.jvm.internal.o oVar) {
