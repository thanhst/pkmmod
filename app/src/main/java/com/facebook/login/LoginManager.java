...
public class LoginManager {
    ...
    static final class AndroidxActivityResultRegistryOwnerStartActivityDelegate implements StartActivityDelegate {
        ...
        public void startActivityForResult(@NotNull Intent intent, int i2) {
            ...
            loginManager$AndroidxActivityResultRegistryOwnerStartActivityDelegate$startActivityForResult$LauncherHolder.setLauncher(this.activityResultRegistryOwner.getActivityResultRegistry().j("facebook-login", new d.a<Intent, Pair<Integer, Intent>>() { // from class: com.facebook.login.LoginManager$AndroidxActivityResultRegistryOwnerStartActivityDelegate$startActivityForResult$1
                @Override // d.a
                @NotNull
    ...
    public final class FacebookLoginActivityResultContract extends d.a<Collection<? extends String>, CallbackManager.ActivityResultParameters> {
