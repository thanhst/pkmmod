...
public class d_KRgTbxlWh extends ImageView {
    ...
    class a implements Runnable {
        ...
        public void run() {
            d_KRgTbxlWh dKRgTbxlWhVar = d_KRgTbxlWh.this;
            dKRgTbxlWhVar.setImageBitmap(dKRgTbxlWhVar.f3205e.get(dKRgTbxlWhVar.f3209i));
        }
    }
    ...
    public d_KRgTbxlWh(Context context) {
        super(context);
    ...
    public void b() {
        if (this.f3210j <= 0) {
            e_KRgTbxlWh.a("image anim:no frame");
            return;
        }
        this.f3206f = true;
        this.f3209i = 0;
            ...
            if (getContext() != null) {
                ...
                for (int i5 = i3 - 1; i5 < i4; i5++) {
                    ...
                    if (bitmapDecodeResource != null) {
                        ...
                        e_KRgTbxlWh.a("image anim:no image=>loading_anim_" + i5);
                    }
                }
            }
            this.f3208h = i2;
