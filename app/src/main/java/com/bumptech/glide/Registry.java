...
public class Registry {
    ...
    public Registry() {
        e<List<Throwable>> eVarThreadSafeList = FactoryPools.threadSafeList();
        this.throwableListPool = eVarThreadSafeList;
        this.modelLoaderRegistry = new ModelLoaderRegistry(eVarThreadSafeList);
