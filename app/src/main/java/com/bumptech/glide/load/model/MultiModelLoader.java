...
class MultiModelLoader<Model, Data> implements ModelLoader<Model, Data> {
    private final e<List<Throwable>> exceptionListPool;
    ...
    static class MultiFetcher<Data> implements DataFetcher<Data>, DataFetcher.DataCallback<Data> {
        ...
        private final e<List<Throwable>> throwableListPool;

        MultiFetcher(@NonNull List<DataFetcher<Data>> list, @NonNull e<List<Throwable>> eVar) {
    ...
    MultiModelLoader(@NonNull List<ModelLoader<Model, Data>> list, @NonNull e<List<Throwable>> eVar) {
