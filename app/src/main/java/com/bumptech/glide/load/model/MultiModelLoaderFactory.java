...
public class MultiModelLoaderFactory {
    ...
    static class Factory {
        ...
        @NonNull
        public <Model, Data> MultiModelLoader<Model, Data> build(@NonNull List<ModelLoader<Model, Data>> list, @NonNull e<List<Throwable>> eVar) {
    ...
    @VisibleForTesting
    MultiModelLoaderFactory(@NonNull e<List<Throwable>> eVar, @NonNull Factory factory) {
