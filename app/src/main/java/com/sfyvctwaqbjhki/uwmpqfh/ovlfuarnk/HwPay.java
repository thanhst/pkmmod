...
public class HwPay extends ZYlKAS {

    /* renamed from: com.sfyvctwaqbjhki.uwmpqfh.ovlfuarnk.HwPay$7, reason: invalid class name */
    ...
    public void consumeAsync(Activity activity, final AibIyCdHmGwOql aibIyCdHmGwOql) {
        ...
        ReDqOTXKRs.payCostOrder(OpHzXGktYUTIAhi.HW_PLUGIN, activity, new DIUGfDWQpOJHLr.ParamGetter() { // from class: com.sfyvctwaqbjhki.uwmpqfh.ovlfuarnk.HwPay.6
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void serverCheckOrder(final Activity activity, final AibIyCdHmGwOql aibIyCdHmGwOql) {
        NetParamsBean netParamsBean = Response.getInstance().getNetParamsBean();
        ...
        MhrJWomE.netConsumeOrder(new UserManager(UserManager.Type.CONSUMEORDER) { // from class: com.sfyvctwaqbjhki.uwmpqfh.ovlfuarnk.HwPay.5
            ...
            public void response(Response response) {
                LogUtils.e("sdk 服务器发货成功");
                HwPay.this.consumeAsync(activity, aibIyCdHmGwOql);
                if (KcUwgofnY.getInstance().getPayComponentCallBack() != null) {
    ...
    public void startPay(Activity activity) {
        LogUtils.e("hw pay start pay...");
        ReDqOTXKRs.payStart(OpHzXGktYUTIAhi.HW_PLUGIN, activity, new DIUGfDWQpOJHLr.ParamGetter<OEtWoBzalfeg>() { // from class: com.sfyvctwaqbjhki.uwmpqfh.ovlfuarnk.HwPay.4
    ...
    public void doPay(final Activity activity) {
        MhrJWomE.netMakeOrder(new UserManager(UserManager.Type.MAKEORDER) { // from class: com.sfyvctwaqbjhki.uwmpqfh.ovlfuarnk.HwPay.3
            @Override // com.sfyvctwaqbjhki.uwmpqfh.mcluykfz.UserManager
            public void fail(int i2, String str) {
                if (KcUwgofnY.getInstance().getPayComponentCallBack() != null) {
                    KcUwgofnY.getInstance().getPayComponentCallBack().payFail(i2, str);
    ...
    public void init(final Activity activity) {
        ReDqOTXKRs.payInit(OpHzXGktYUTIAhi.HW_PLUGIN, activity, new DIUGfDWQpOJHLr.ParamGetter<EHpbXBY>() { // from class: com.sfyvctwaqbjhki.uwmpqfh.ovlfuarnk.HwPay.1
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.ykiocnwpdseglq.lbmntzwepqakgu.interfaces.DIUGfDWQpOJHLr.ParamGetter
        ...
        }, new PurchaseListener<AibIyCdHmGwOql>() { // from class: com.sfyvctwaqbjhki.uwmpqfh.ovlfuarnk.HwPay.2
            ...
            public void initCallBack(PurchaseListener.PurchaseInitState purchaseInitState, String str) {
                ...
                if (i2 == 1) {
                    LogUtils.e("hw pay is init success");
                } else {
                    if (i2 != 2) {
                        return;
                    }
                    LogUtils.e("hw pay is init fail");
                }
            }
            ...
            public void payCallBack(PurchaseListener.PurchaseState purchaseState, AibIyCdHmGwOql aibIyCdHmGwOql, String str) {
                ...
                if (i2 == 1) {
                    HwPay.this.serverCheckOrder(activity, aibIyCdHmGwOql);
                    return;
                }
                if (i2 != 2) {
                    if (i2 != 3) {
