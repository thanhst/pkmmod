...
public class b_i<K, V> implements Iterable<Map.Entry<K, V>> {
    ...
    public boolean equals(Object obj) {
        ...
        Iterator<Map.Entry<K, V>> it2 = bIVar.iterator();
