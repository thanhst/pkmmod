...
public final class j {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final s0.f h(MatchResult matchResult) {
        return s0.l.h(matchResult.start(), matchResult.end());
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final s0.f i(MatchResult matchResult, int i2) {
        return s0.l.h(matchResult.start(i2), matchResult.end(i2));
    }
