...
public class StringsKt__IndentKt extends l {
    private static final l_p0<String, String> b(final String str) {
        return str.length() == 0 ? new l_p0<String, String>() { // from class: kotlin.text.StringsKt__IndentKt$getIndentFunction$1
            @Override // p0.l
            @NotNull
        ...
        } : new l_p0<String, String>() { // from class: kotlin.text.StringsKt__IndentKt$getIndentFunction$2
    ...
    public static final String d(@NotNull String str, @NotNull String newIndent) {
        ...
        l_p0<String, String> lP0VarB = b(newIndent);
        ...
        for (Object obj2 : listP) {
            ...
            if ((i2 == 0 || i2 == iJ) && s.m(str2)) {
                ...
                if (strR0 != null && (strInvoke = lP0VarB.invoke(strR0)) != null) {
                    str2 = strInvoke;
                }
            }
            if (str2 != null) {
