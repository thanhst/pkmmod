...
public final class MapBuilder<K, V> implements Map<K, V>, Serializable, q0.a {
    ...
    private static final class a {
        ...
        public final int c(int capacity) {
            return Integer.highestOneBit(l.a(capacity, 1) * 3);
        }
    ...
    public static final class b<K, V> extends d<K, V> implements Iterator<Map.Entry<K, V>>, q0.a {
    ...
    public static final class c<K, V> implements Map.Entry<K, V>, q0.a {
    ...
    public static final class e<K, V> extends d<K, V> implements Iterator<K>, q0.a {
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    ...
    public static final class f<K, V> extends d<K, V> implements Iterator<V>, q0.a {
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    ...
    private final void removeHashAt(int i2) {
        int iC = l.c(this.maxProbeDistance * 2, getHashSize() / 2);
        int i3 = 0;
        int i4 = i2;
        do {
    ...
    public void clear() {
        checkIsMutable$kotlin_stdlib();
        g0 it = new s0.f(0, this.length - 1).iterator();
        while (it.hasNext()) {
