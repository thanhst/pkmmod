...
final class SynchronizedLazyImpl<T> implements d<T>, Serializable {
    ...
    public SynchronizedLazyImpl(@NotNull a_p0<? extends T> initializer, @Nullable Object obj) {
    ...
    public /* synthetic */ SynchronizedLazyImpl(a_p0 aP0Var, Object obj, int i2, kotlin.jvm.internal.o oVar) {
        this(aP0Var, (i2 & 2) != 0 ? null : obj);
    }
}
