...
public abstract class Random {
    ...
    @NotNull
    private static final Random defaultRandom = b_l0.F_4023_AL_0.b();
    ...
    public byte[] nextBytes(@NotNull byte[] array, int fromIndex, int toIndex) {
        s.e(array, "array");
        if (!(new f_s0(0, array.length).f(fromIndex) && new f_s0(0, array.length).f(toIndex))) {
    ...
    public long nextLong(long from, long until) {
        ...
        if (((-j3) & j3) == j3) {
            ...
            if (i2 != 0) {
                ...
                jNextBits = (nextBits(d.e(i3)) << 32) + (nextInt() & 4294967295L);
            }
