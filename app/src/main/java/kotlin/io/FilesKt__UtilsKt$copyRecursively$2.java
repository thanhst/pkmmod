...
final class FilesKt__UtilsKt$copyRecursively$2 extends Lambda implements p_p0<File, IOException, t> {
    final /* synthetic */ p_p0<File, IOException, OnErrorAction> $onError;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    FilesKt__UtilsKt$copyRecursively$2(p_p0<? super File, ? super IOException, ? extends OnErrorAction> pP0Var) {
        super(2);
        this.$onError = pP0Var;
    }
