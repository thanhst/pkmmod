...
public class AdaptedFunctionReference implements p, Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        return this.isTopLevel == adaptedFunctionReference.isTopLevel && this.arity == adaptedFunctionReference.arity && this.flags == adaptedFunctionReference.flags && s.a(this.receiver, adaptedFunctionReference.receiver) && s.a(this.owner, adaptedFunctionReference.owner) && this.name.equals(adaptedFunctionReference.name) && this.signature.equals(adaptedFunctionReference.signature);
    }
