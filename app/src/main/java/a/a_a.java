...
public interface a_a extends IInterface {

    /* compiled from: ICustomTabsCallback.java */
    /* renamed from: a.a$a, reason: collision with other inner class name */
    public static abstract class AbstractBinderC0000AA extends Binder implements a_a {

        /* compiled from: ICustomTabsCallback.java */
        /* renamed from: a.a$a$a, reason: collision with other inner class name */
        private static class C0001AA implements a_a {

            /* renamed from: a, reason: collision with root package name */
            private IBinder f1a;

            C0001AA(IBinder iBinder) {
                this.f1a = iBinder;
            }
        ...
        public AbstractBinderC0000AA() {
            attachInterface(this, "android.support.customtabs.ICustomTabsCallback");
        }

        public static a_a C(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface iInterfaceQueryLocalInterface = iBinder.queryLocalInterface("android.support.customtabs.ICustomTabsCallback");
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof a_a)) ? new C0001AA(iBinder) : (a_a) iInterfaceQueryLocalInterface;
        }
