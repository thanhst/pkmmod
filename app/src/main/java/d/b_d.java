...
public final class b_d extends a_d<String[], Map<String, Boolean>> {
    ...
    public a_d.C0048a<Map<String, Boolean>> getSynchronousResult(@NotNull Context context, @NotNull String[] input) {
        s.e(context, "context");
        s.e(input, "input");
        boolean z2 = true;
        if (input.length == 0) {
            return new a_d.C0048a<>(l0.f());
        }
        ...
        LinkedHashMap linkedHashMap = new LinkedHashMap(l_s0.a(k0.c(input.length), 16));
        for (String str : input) {
            Pair pairA = j.a(str, Boolean.TRUE);
            linkedHashMap.put(pairA.getFirst(), pairA.getSecond());
        }
        return new a_d.C0048a<>(linkedHashMap);
    }
