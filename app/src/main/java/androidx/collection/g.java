...
public class g<K, V> {
    ...
    public g() {
        this.mHashes = c.f1317a;
        this.mArray = c.f1319c;
        this.mSize = 0;
    }
        ...
        if (obj instanceof g) {
            ...
            for (int i2 = 0; i2 < this.mSize; i2++) {
                try {
                    ...
                    Object obj2 = gVar.get(kKeyAt);
                    if (vValueAt == null) {
                        if (obj2 != null || !gVar.containsKey(kKeyAt)) {
                            return false;
                        }
    ...
    public void putAll(@NonNull g<? extends K, ? extends V> gVar) {
        int i2 = gVar.mSize;
