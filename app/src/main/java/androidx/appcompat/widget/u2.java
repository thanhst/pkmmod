...
public class u2 extends a2 {
    ...
    private static boolean f1165c = false;

    /* renamed from: b, reason: collision with root package name */
    private final WeakReference<Context> f1166b;

    public u2(@NonNull Context context, @NonNull Resources resources) {
        super(resources);
        this.f1166b = new WeakReference<>(context);
    }
    ...
    @Override // androidx.appcompat.widget.a2, android.content.res.Resources
    ...
    public Drawable getDrawable(int i2) throws Resources.NotFoundException {
        Context context = this.f1166b.get();
        return context != null ? z1.h().t(context, this, i2) : a(i2);
    }
