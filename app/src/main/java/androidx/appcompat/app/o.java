...
class o {
    ...
    @NonNull
    private final Deque<WeakReference<XmlPullParser>> f277a = new ArrayDeque();
    ...
    boolean a(@NonNull AttributeSet attributeSet) {
        ...
        XmlPullParser xmlPullParserC = c(this.f277a);
        this.f277a.push(new WeakReference<>(xmlPullParser));
