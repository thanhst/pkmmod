        ...
        for (Pair<String, ? extends Object> pair : pairs) {
            ...
            if (objComponent2 == null) {
                ...
                if (Parcelable.class.isAssignableFrom(componentType)) {
                    s.c(objComponent2, "null cannot be cast to non-null type kotlin.Array<android.os.Parcelable>");
                    bundle.putParcelableArray(strComponent1, (Parcelable[]) objComponent2);
                } else if (String.class.isAssignableFrom(componentType)) {
                    s.c(objComponent2, "null cannot be cast to non-null type kotlin.Array<kotlin.String>");
                    bundle.putStringArray(strComponent1, (String[]) objComponent2);
                } else if (CharSequence.class.isAssignableFrom(componentType)) {
                    s.c(objComponent2, "null cannot be cast to non-null type kotlin.Array<kotlin.CharSequence>");
                ...
                if (objComponent2 instanceof IBinder) {
                    a.a(bundle, strComponent1, (IBinder) objComponent2);
                } else if (i2 >= 21 && (objComponent2 instanceof Size)) {
                    d.a(bundle, strComponent1, (Size) objComponent2);
                } else {
                    if (i2 < 21 || !(objComponent2 instanceof SizeF)) {
                        throw new IllegalArgumentException("Illegal value type " + objComponent2.getClass().getCanonicalName() + " for key \"" + strComponent1 + '\"');
                    }
                    d.b(bundle, strComponent1, (SizeF) objComponent2);
                }
            }
        }
        return bundle;
