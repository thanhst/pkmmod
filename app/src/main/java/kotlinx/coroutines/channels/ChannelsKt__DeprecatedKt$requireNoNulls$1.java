...
final class ChannelsKt__DeprecatedKt$requireNoNulls$1 extends SuspendLambda implements p_p0 {
    ...
    public final Object invoke(@Nullable Object obj, @Nullable kotlin.coroutines.c cVar) {
        return ((ChannelsKt__DeprecatedKt$requireNoNulls$1) create(obj, cVar)).invokeSuspend(kotlin.t.f3507a);
    }
