...
final class ChannelsKt__DeprecatedKt$drop$1 extends SuspendLambda implements p0.p {
    ...
    ChannelsKt__DeprecatedKt$drop$1(int i2, ReceiveChannel receiveChannel, kotlin.coroutines.c cVar) {
        super(2, cVar);
        this.$n = i2;
    ...
    public final Object invoke(@NotNull n nVar, @Nullable kotlin.coroutines.c cVar) {
        return ((ChannelsKt__DeprecatedKt$drop$1) create(nVar, cVar)).invokeSuspend(kotlin.t.f3507a);
    }
