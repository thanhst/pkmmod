...
final class ChannelsKt__DeprecatedKt$takeWhile$1 extends SuspendLambda implements p0.p {
    ...
    ChannelsKt__DeprecatedKt$takeWhile$1(ReceiveChannel receiveChannel, p0.p pVar, kotlin.coroutines.c cVar) {
        super(2, cVar);
