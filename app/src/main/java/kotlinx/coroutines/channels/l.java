...
public class l<E> extends AbstractChannel<E> {
    public l(@Nullable p0.l<? super E, kotlin.t> lVar) {
        super(lVar);
    }
        ...
        if (list != null) {
            if (list instanceof ArrayList) {
                ...
                if (size >= 0) {
                    ...
                    while (true) {
                        ...
                        if (rVar instanceof b.a) {
                            ...
                            undeliveredElementExceptionC2 = lVar == null ? null : OnUndeliveredElementKt.c(lVar, ((b.a) rVar).element, undeliveredElementExceptionC2);
                        } else {
                            rVar.S(closed);
                        }
                        if (i2 < 0) {
                ...
                if (rVar2 instanceof b.a) {
                    p0.l<E, kotlin.t> lVar2 = this.onUndeliveredElement;
                    if (lVar2 != null) {
                        undeliveredElementExceptionC = OnUndeliveredElementKt.c(lVar2, ((b.a) rVar2).element, null);
                    }
                } else {
                    rVar2.S(closed);
                }
