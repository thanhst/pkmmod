...
final class ChannelsKt__DeprecatedKt$distinct$1 extends SuspendLambda implements p0.p {
    ...
    public final Object invoke(Object obj, @Nullable kotlin.coroutines.c cVar) {
        return ((ChannelsKt__DeprecatedKt$distinct$1) create(obj, cVar)).invokeSuspend(kotlin.t.f3507a);
    }
