...
public interface a<R> {
    ...
    void d(long timeMillis, @NotNull l_p0<? super c<? super R>, ? extends Object> block);

    <Q> void i(@NotNull d<? extends Q> dVar, @NotNull p_p0<? super Q, ? super c<? super R>, ? extends Object> pP0Var);
}
