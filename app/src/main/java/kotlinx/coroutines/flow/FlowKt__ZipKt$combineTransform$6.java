...
public final class FlowKt__ZipKt$combineTransform$6 extends SuspendLambda implements p0.p<e<Object>, kotlin.coroutines.c<? super kotlin.t>, Object> {
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public FlowKt__ZipKt$combineTransform$6(d<Object>[] dVarArr, p0.q<? super e<Object>, ? super Object[], ? super kotlin.coroutines.c<? super kotlin.t>, ? extends Object> qVar, kotlin.coroutines.c<? super FlowKt__ZipKt$combineTransform$6> cVar) {
        super(2, cVar);
        this.$flows = dVarArr;
        this.$transform = qVar;
    }
    ...
    public final Object invoke(@NotNull e<Object> eVar, @Nullable kotlin.coroutines.c<? super kotlin.t> cVar) {
        return ((FlowKt__ZipKt$combineTransform$6) create(eVar, cVar)).invokeSuspend(kotlin.t.f3507a);
    }
