...
@Metadata(bv = {}, d1 = {"\u0000\u0010\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\u0010\u0005\u001a\u00020\u0004\"\u0004\b\u0000\u0010\u0000\"\u0004\b\u0001\u0010\u00012\f\u0010\u0003\u001a\b\u0012\u0004\u0012\u00028\u00010\u0002H\u008a@"}, d2 = {"S", "T", "Lkotlinx/coroutines/flow/e;", "it", "Lkotlin/t;", "<anonymous>"}, k = 3, mv = {1, 6, 0})
@DebugMetadata(c = "kotlinx.coroutines.flow.internal.ChannelFlowOperator$collectWithContextUndispatched$2", f = "ChannelFlow.kt", i = {}, l = {152}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes.dex */
final class ChannelFlowOperator$collectWithContextUndispatched$2<T> extends SuspendLambda implements p_p0<e<? super T>, c<? super t>, Object> {
    ...
    @Override // p0.p
    @Nullable
    public final Object invoke(@NotNull kotlinx.coroutines.flow.e<? super T> eVar, @Nullable kotlin.coroutines.c<? super t> cVar) {
        return ((ChannelFlowOperator$collectWithContextUndispatched$2) create(eVar, cVar)).invokeSuspend(t.f3507a);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i2 == 0) {
            ...
            this.label = 1;
            if (channelFlowOperator.p(eVar, this) == objD) {
                return objD;
            }
        } else {
            if (i2 != 1) {
