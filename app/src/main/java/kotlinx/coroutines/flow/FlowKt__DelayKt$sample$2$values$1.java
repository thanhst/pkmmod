...
final class FlowKt__DelayKt$sample$2$values$1 extends SuspendLambda implements p0.p<kotlinx.coroutines.channels.n<? super Object>, kotlin.coroutines.c<? super kotlin.t>, Object> {
    ...
    static final class AnonymousClass1<T> implements e {
        ...
        final /* synthetic */ kotlinx.coroutines.channels.n<Object> f3680e;
        ...
        */
        public final java.lang.Object emit(T r5, @org.jetbrains.annotations.NotNull kotlin.coroutines.c<? super kotlin.t> r6) {
            ...
            L31:
                kotlin.h.b(r6)
                kotlinx.coroutines.channels.n<java.lang.Object> r6 = r4.f3680e
                if (r5 != 0) goto L3a
    ...
    FlowKt__DelayKt$sample$2$values$1(d<Object> dVar, kotlin.coroutines.c<? super FlowKt__DelayKt$sample$2$values$1> cVar) {
        super(2, cVar);
    ...
    public final Object invoke2(@NotNull kotlinx.coroutines.channels.n<Object> nVar, @Nullable kotlin.coroutines.c<? super kotlin.t> cVar) {
        return ((FlowKt__DelayKt$sample$2$values$1) create(nVar, cVar)).invokeSuspend(kotlin.t.f3507a);
    }
