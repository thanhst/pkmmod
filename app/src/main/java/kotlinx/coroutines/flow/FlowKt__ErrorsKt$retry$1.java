...
final class FlowKt__ErrorsKt$retry$1 extends SuspendLambda implements p0.p<Throwable, kotlin.coroutines.c<? super Boolean>, Object> {
    int label;
    ...
    public final Object invoke(@NotNull Throwable th, @Nullable kotlin.coroutines.c<? super Boolean> cVar) {
        return ((FlowKt__ErrorsKt$retry$1) create(th, cVar)).invokeSuspend(kotlin.t.f3507a);
    }
