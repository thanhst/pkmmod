...
final class FlowKt__MigrationKt$delayEach$1 extends SuspendLambda implements p0.p<Object, kotlin.coroutines.c<? super kotlin.t>, Object> {
    final /* synthetic */ long $timeMillis;
    int label;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    FlowKt__MigrationKt$delayEach$1(long j2, kotlin.coroutines.c<? super FlowKt__MigrationKt$delayEach$1> cVar) {
        super(2, cVar);
        this.$timeMillis = j2;
    }
    ...
    @Override // p0.p
    @Nullable
    public final Object invoke(Object obj, @Nullable kotlin.coroutines.c<? super kotlin.t> cVar) {
        return ((FlowKt__MigrationKt$delayEach$1) create(obj, cVar)).invokeSuspend(kotlin.t.f3507a);
    }
