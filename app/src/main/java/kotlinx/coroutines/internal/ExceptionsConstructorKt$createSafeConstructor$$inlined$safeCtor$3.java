...
public final class ExceptionsConstructorKt$createSafeConstructor$$inlined$safeCtor$3 extends Lambda implements p0.l<Throwable, Throwable> {
    ...
    public final Throwable invoke(@NotNull Throwable th) {
        ...
        th3.initCause(th);
        objM158constructorimpl = Result.m158constructorimpl(th3);
