...
public final class f_s0 extends d_s0 {
    ...
    @NotNull
    private static final f_s0 F_S_04115_J = new f_s0(1, 0);
    ...
    public static final class Companion {
        ...
        @NotNull
        public final f_s0 a() {
            return f_s0.F_S_04115_J;
        }
    }

    public f_s0(int i2, int i3) {
        super(i2, i3, 1);
    }

    @Override // s0.d
    public boolean equals(@Nullable Object other) {
        if (other instanceof f_s0) {
            if (!isEmpty() || !((f_s0) other).isEmpty()) {
                f_s0 fS0Var = (f_s0) other;
                if (getFirst() != fS0Var.getFirst() || getLast() != fS0Var.getLast()) {
                }
            }
            return true;
        }
