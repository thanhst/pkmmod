...
public class g_s0 implements Iterable<Long>, a_q0 {
    ...
    public g_s0(long j2, long j3, long j4) {
        if (j4 == 0) {
    ...
    public h0 iterator() {
        return new h_s0(this.first, this.last, this.step);
    }
}
