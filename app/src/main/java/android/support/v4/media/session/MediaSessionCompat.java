...
public class MediaSessionCompat {
    ...
    static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        class MediaSessionStub extends IMediaSession.Stub {
            ...
            void postToHandler(int i2, int i3, int i4) {
                MediaSessionImplBase.this.postToHandler(i2, i3, i4, null, null);
            }
        ...
        private void sendCaptioningEnabled(boolean z2) {
            synchronized (this.mLock) {
                for (int iBeginBroadcast = this.mControllerCallbacks.beginBroadcast() - 1; iBeginBroadcast >= 0; iBeginBroadcast--) {
                    try {
                        ((IMediaControllerCallback) this.mControllerCallbacks.getBroadcastItem(iBeginBroadcast)).onCaptioningEnabledChanged(z2);
        ...
        String getPackageNameForUid(int i2) {
    ...
    static final class RegistrationCallbackHandler extends Handler {
        ...
        public void postCallbackRegistered(int i2, int i3) {
            obtainMessage(MSG_CALLBACK_REGISTERED, i2, i3).sendToTarget();
        }

        public void postCallbackUnregistered(int i2, int i3) {
            obtainMessage(MSG_CALLBACK_UNREGISTERED, i2, i3).sendToTarget();
        }
    }
        ...
        public void setCaptioningEnabled(boolean z2) {
            if (this.mCaptioningEnabled != z2) {
                ...
                synchronized (this.mLock) {
                    for (int iBeginBroadcast = this.mExtraControllerCallbacks.beginBroadcast() - 1; iBeginBroadcast >= 0; iBeginBroadcast--) {
                        try {
                            ((IMediaControllerCallback) this.mExtraControllerCallbacks.getBroadcastItem(iBeginBroadcast)).onCaptioningEnabledChanged(z2);
                        } catch (RemoteException unused) {
                        }
                    }
                    this.mExtraControllerCallbacks.finishBroadcast();
