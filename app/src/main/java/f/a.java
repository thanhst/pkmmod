...
public class a extends f.g implements r {

    /* renamed from: x, reason: collision with root package name */
    private static final String f3227x = a.class.getSimpleName();
    ...
    static class c extends g.a {
        ...
        c(@Nullable c cVar, @NonNull a aVar, @Nullable Resources resources) {
    ...
    a(@Nullable c cVar, @Nullable Resources resources) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
        super(null);
        this.f3230u = -1;
        this.f3231v = -1;
