...
public class b_f extends Drawable implements Drawable.Callback {
    ...
    static abstract class d extends Drawable.ConstantState {
        ...
        d(d dVar, b_f bFVar, Resources resources) {
            this.f3262i = false;
            this.f3265l = false;
            this.f3277x = true;
            this.A = 0;
            ...
            int iF = b_f.f(resources, dVar != null ? dVar.f3256c : 0);
            this.f3256c = iF;
            if (dVar == null) {
        ...
        final void y(Resources resources) {
            if (resources != null) {
                ...
                int iF = b_f.f(resources, this.f3256c);
                int i2 = this.f3256c;
                this.f3256c = iF;
                if (i2 != iF) {
                    this.f3266m = false;
