...
public final class a_u {
    ...
    private a_u(Context context) {
        this.f4135a = context;
        this.f4139e = new HandlerC0072a(context.getMainLooper());
    }

    @NonNull
    public static a_u b(@NonNull Context context) {
        a_u aUVar;
        synchronized (f4133f) {
            if (f4134g == null) {
                f4134g = new a_u(context.getApplicationContext());
            }
            aUVar = f4134g;
        }
        return aUVar;
